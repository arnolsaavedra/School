...
?>
    <HTML>
        ...
        <meta name="robots" content="index, follow"> 
            ...
            <title>Programas | San Pedro Claver Neiva</title>
        </HEAD> 
        <BODY>
            ...
            <div class="background-title-page" style="background-image: url(../imagen/cursosydiplomados.jpg);">
                <div style="margin-right: 2%;" >
                 <h2 class="title-curse">Programas</h2>
                </div>
            </div>
    ...
    <h3 style="text-align:center;color:white;margin-top: 0;"><b>PROGRAMAS</b></h3>
                        ...
                        <div style="width:100%;text-align:center;" >
                            <section id="programasSanPedroClaver" name="programasSanPedroClaver">
        ...
        <script src="../js/listaProgramas.js" type="text/javascript"></script>
