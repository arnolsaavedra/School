...
?>
    <HTML>
        ...
        <meta name="robots" content="index, follow"> 
            ...
            <title>Noticias | San Pedro Claver Neiva</title>
        </HEAD> 
        <BODY>
            ...
            <div class="background-title-curse" style="background-image: url(../imagen/nosotrosFondo.jpg);">
                <div style="margin-right: 2%;" >
                 <h2 class="title-curse">Noticias</h2>
                </div>
            </div>
            <div id="curso_diplomado" name="curso_diplomado" class="CJtext" style="text-align:center;" > 
            
            <section  id="noticiasPrincipales" name="noticiasPrincipales">
                <div class="card-panel" id="listaNoticias" name="listaNoticias" style="width:60%;height:auto;display:inline-table;padding-top: 0;">
                    <div style="background-color:#0d883e;    border-bottom-left-radius: 50px;border-bottom-right-radius: 50px;">
                        <h3 style="text-align:center;color:white;margin-top: 0;"><b>Noticias Principales</b></h3>
                        </div>
                    <hr>
                    <section id="listadoNoticias" name="listadoNoticias">
                        
                    </section>
                </div>
                <div class="card-panel" id="listaNoticiasRecomenda" name="listaNoticiasRecomenda" style="text-align:center;width:30%;height:auto;display:inline-table;padding-top: 0;">
                    <div style="text-align: center;">
                        <div style="background-color:#0d883e;    border-bottom-left-radius: 50px;border-bottom-right-radius: 50px;">
                        <h3 style="text-align:center;color:white;margin-top: 0;"><b>Programas</b></h3>
                        </div>
