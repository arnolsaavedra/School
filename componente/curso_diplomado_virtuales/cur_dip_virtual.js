  ...
  var urlcontrollerVirtual1 = "../controller/listaCursoVirtual.php";
...
function carruselVirtual(){
        $('#owl-2Virtual .owl-carousel').owlCarousel(
    {
        items:1,
        loop:true,
        margin:24,
...
function cargarListaCursoVirtual() {
        ...
        success: function (result) {
            ...
            for(var contador = 0; contador < result.length;contador++){
                cargarListaCursoPasoVirtual1(result[contador]["idCurso"]);
            }
            }
        },
    })
...
function cargarListaCursoPasoVirtual1(idCurso) {
        ...
        success: function (result) {
            ...
            infoCurso = "";
            $('#loaderCursosVir').empty();
            $('#loaderCursosVir').hide();
            infoCurso = "<div id='caracteristicaZoneTres'  class='tamanoTargetCurso'>"+
                ...
                "<br>"+
            "</div>";
            $('#listaCursosVirtual').append(infoCurso);
            }
        },
