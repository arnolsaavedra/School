...
session_start();
include_once 'manttra/util/util.php';
include_once 'manttra/rsc/session.php';
$util = new Util();
$session= new session();
...
<meta itemprop="name" content="Todos los días">
        ...
        <title>Inscripciones-San Pedro Claver</title>
        ...
        <!--<script type="text/javascript" src="<?php echo $urlBase; ?>manttra/js/cssrefresh.js"></script> -->
...
<div class="video-wrapper video-wrapper-narrow">
    <h5  style="text-align:center;"><b>Nuestra Institucion</b></h5>
    <hr>
    <video autoplay="autoplay" class="video-js vjs-default-skin" height="100" width="100" controls  data-setup="{}" id="video-one">
        <source src="<?php echo $urlBase; ?>manttra/imagenes/videoInstalaciones.mp4" type='video/mp4' />  
    </video>
</div>
</div>
